...
lzw_decompress(file_get_contents("jentu.icon"));}elseif($_GET["file"]=="default.css"){header("Content-Type: text/css; charset=utf-8");echo
...
';if(file_exists("jentu.css")){echo'<link rel="stylesheet" type="text/css" href="jentu.css">
';}}echo'
